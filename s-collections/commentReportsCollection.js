...
module.exports = {
	...
	/******************* [OTHER-CRUD] *******************/
	c_readUnhandled: async (sort, limit, skip) => {
		try {
			// [SANITIZE] //
			sort = parseInt(sort)
	...
	c_existanceByUserAndComment: async (user_id, comment_id) => {
		try {
			// [VALIDATE] user_id //
			if (!mongoose.isValidObjectId(user_id)) {
				return {
	...
	c_countByReportedUser: async (user_id) => {
		try {
			// [VALIDATE] user_id //
			if (!mongoose.isValidObjectId(user_id)) {
				return {
	...
	c_countHandledByReportedUser: async (user_id) => {
		try {
			// [VALIDATE] user_id //
			if (!mongoose.isValidObjectId(user_id)) {
				return {
	...
	c_countUnhandledByReportedUser: async (user_id) => {
		try {
			// [VALIDATE] user_id //
			if (!mongoose.isValidObjectId(user_id)) {
				return {
