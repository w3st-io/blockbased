...
const a_admininstration_reports = require('./s-routes/api/administration/reports')
...
const p_user_activity_view = require('./s-routes/pages/user/activity/view')
...
const p_user_profile_view = require('./s-routes/pages/user/profile/view')
...
app.use('/api/administration/reports', a_admininstration_reports)
...
app.use('/pages/user/activity/view', p_user_activity_view)
...
app.use('/pages/user/profile/view', p_user_profile_view)
