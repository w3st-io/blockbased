...
const p_cat_postCreate = require('./s-routes/pages/cat/post-create')
const p_post = require('./s-routes/pages/post')
const p_post_commentCreate = require('./s-routes/pages/post/comment-create')
...
app.use('/pages/cat/post-create', p_cat_postCreate)
app.use('/pages/post', p_post)
app.use('/pages/post/comment-create', p_post_commentCreate)
