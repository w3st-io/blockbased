...
const p_admin_function_users_record = require('./s-routes/pages/admin/function/users/record')
...
app.use('/pages/admin/function/users/record', p_admin_function_users_record)
