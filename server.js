...
app.use('/api/posts', Universal.userSystem(), a_posts)
app.use('/api/comments', Universal.userSystem(), a_comments)
app.use('/api/notifications', Universal.userSystem(), a_notifications)
app.use('/api/users', Universal.userSystem(), a_users)
